    ...
    public void spawn() {
        ...
        Bukkit.getScheduler().runTaskLater(plugin, () -> {
            if (!getHandle().connection.connection.isConnected()) {
                this.connection = new ConnectionFactory(hostname, port).createConnection();
                CommonListenerCookie cookie = new CommonListenerCookie(getHandle().getGameProfile(), getHandle().getId(), Bot.CLIENT_INFORMATION, false);
            ...
            new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    Bukkit.getScheduler().runTask(plugin, () -> {
                        Bot.SERVER.getPlayerList().placeNewPlayer(connection, getHandle(), new CommonListenerCookie(getProfile(), entity.getId(), Bot.CLIENT_INFORMATION, false));
